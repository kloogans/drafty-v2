    ...
    <Layout className="min-h-screen max-w-3xl !justify-start pt-32 child:text-left child:w-full">
      ...
      <div className="w-full p-4 border-2 border-indigo-200 bg-indigo-900 rounded-2xl shadow-md mb-5">
        <p className="text-md text-white mb-4">
          This privacy notice for <strong>https://drafty.cc</strong> ("Company,"
        ...
        <p className="text-md text-white mb-4">
          <strong>
            <em>
              ...
              also click{" "}
              <a href="#toc" className="hover:text-amber-400 font-bold">
                here
              </a>{" "}
        ...
        <p className="text-md text-white mb-4">
          ...
          information depending on how you interact with __________ and the
        ...
        <p className="text-md text-white mb-4">
          ...
          social media platforms, and other outside sources. Click here to learn
          more.
        </p>
        ...
        <p className="text-md text-white mb-4">
          ...
          <br />
          <br />
          Want to learn more about what https://drafty.cc does with any
        ...
        <ol className="w-full flex flex-col text-md text-white/70 mb-4 list-decimal pl-10 border-l-2 border-l-indigo-300">
          <li>
            <TocLink href="#1">WHAT INFORMATION DO WE COLLECT?</TocLink>
          </li>
          <li>
            <TocLink href="#2">HOW DO WE PROCESS YOUR INFORMATION?</TocLink>
          </li>
          <li>
            <TocLink href="#3">
          ...
          <li>
            <TocLink href="#5">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</TocLink>
          </li>
          <li>
            <TocLink href="#6">
          ...
          <li>
            <TocLink href="#7">HOW LONG DO WE KEEP YOUR INFORMATION?</TocLink>
          </li>
          <li>
            <TocLink href="#8">DO WE COLLECT INFORMATION FROM MINORS?</TocLink>
          </li>
          <li>
            <TocLink href="#9">WHAT ARE YOUR PRIVACY RIGHTS?</TocLink>
          </li>
          <li>
            <TocLink href="#10">CONTROLS FOR DO-NOT-TRACK FEATURES</TocLink>
          </li>
          <li>
            <TocLink href="#11">
          ...
          <li>
            <TocLink href="#12">DO WE MAKE UPDATES TO THIS NOTICE?</TocLink>
          </li>
          <li>
            <TocLink href="#13">
        ...
        <ul className="list-disc flex flex-col child:mb-4 pl-8 text-md text-white">
          <li>
        ...
        <p className="text-md text-white mb-4">
          ...
          parties with whom we may share your personal information, in and other
          countries.
          <br />
          <br />
        ...
        <p className="text-md text-white mb-4 font-bold">Account Information</p>
        ...
        <p className="text-md text-white mb-4">
          ...
          or delete your personal information, please submit a request to{" "}
          <a
            href="mailto:help@drafty.cc"
            className="font-bold hover:text-amber-400"
          >
